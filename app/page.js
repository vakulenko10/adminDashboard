  ...
  return(
    ...
    <main className="page pt-[100px] z-0">
      <Container className={'px-3 md:px-1'}>
        ...
        <p>Login button is in the navbar. Remember you won't be able to change anything on your main website through that dashboard unless you are logged in as the admin</p>
        ...
        <p>Some stuff can go wrong sometimes, but that's the demo version of that admin dashboard, so I ran that dashboard online to receive as more feedback from real user experience</p>
        ...
        <h1>Login</h1>
        <p>You won't be able to login into dashboard, unless you are using admin's gmail account in your browser</p>
      </Container>
    </main>
  )
