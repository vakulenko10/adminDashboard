...
const SectionItem = ({item, sectionName, handleDelete}) => {
  ...
  <div className="SectionItem relative flex max-w-full min-w-[250px] h-[600px] md:justify-self-center md:max-w-[370px] md:h-[500px] overflow-hidden flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md lg:max-w-[330px]">
    <div className="imageContainer relative mx-4 mt-4 overflow-hidden rounded-xl bg-white bg-clip-border text-gray-700 h-1/2 ">
    {item.imageURL?<img className="h-full w-full object-cover" src={item.imageURL} />:<>no image</>}
